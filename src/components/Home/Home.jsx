...
import { Card, Carousel, Col, Container, Form, Row, Spinner } from "react-bootstrap";
...
const Home = () => {
  ...
  return (
    ...
    <div className="container">
     {
      !chefData ? <div className="d-flex justify-content-center align-items-center my-5"><Spinner animation="grow" /> </div> : <></>
     }
      <Carousel fade>
        <Carousel.Item className="carousel-bg">
          ...
          <Carousel.Caption>
            <h3>Pepperoni</h3>
            <p>
              Classic pizza with tomato sauce, mozzarella cheese, and slices of
              spicy pepperoni. Perfect for meat lovers.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item className="carousel-bg">
      ...
      <div className="my-4">
        <h2 className="text-center mb-5 fst-italic">We invite you to events</h2>
        <Container className="">
          <Row>
            <Col
              md={3}
          ...
          <Row>
            ...
            >
              <div>
                ...
                <h5 className="text-secondary">Italian Pasta Cooking Class</h5>
              </div>
            </Col>
            <Col
              md={3}
